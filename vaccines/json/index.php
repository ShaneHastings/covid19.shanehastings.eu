...
$vaccinationRatePer100 = round(((getGeoHiveFirstDoseTotals()/$populationIreland)*100), 2);;
...
$jsonResponse->totalSecondDoseAdministered = 'unknown';
$jsonResponse->totalVaccinations = 'unknown';
